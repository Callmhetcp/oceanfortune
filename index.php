...
<body>
    ...
    <span class="tv-ticker-item-tape__change-pt js-symbol-change-pt">(+2.06%)</span>
    ...
    <section class="section_6">
        ...
        <div class="" style=" width: 100%;">
            <iframe class="iframe" src="assets/Draggable Card Slider JavaScriptindex.php" width="100%" height=""  frameborder="0" style="height: 80vh;";></iframe>
        </div>
    </section>
