      ...
      <main class="main_content">
        ...
        <div class="profile-header">
                <div class="profile-photo">
                    <img src="https://ui-avatars.com/api/?name=T+B&color=7F9CF5&background=EBF4FF" alt="Profile Photo">
                ...
                <p class="email" id="user_id"><?php echo htmlspecialchars($user_id); ?></p>
            ...
            <section class="profile-section">
                ...
                <form class="profile-form" method="POST" action="">
                    <div class="form-group">
                        ...
                        <input type="text" id="fname" name="fname" value="<?php echo htmlspecialchars($user_fname); ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="lname">Last Name</label>
                        <input type="text" id="lname" name="lname" value="<?php echo htmlspecialchars($user_lname); ?>" required>
                    </div>
                    <div class="form-group">
